...
public class Radar : MonoBehaviour
{
    ...
    public static void RegisterRadarObject(GameObject o, GameObject i)
    {
        GameObject image = Instantiate(i);
    ...
    private void DrawRadarDots() // Синхронизирует значки на миникарте с реальнымиобъектами
    {
